...
import { StudentNotificationsList } from '@/features/eleve/student-notifications-list'
import { excludeMessagingNotificationTypes } from '@/lib/notifications/categories'
import type { Metadata } from 'next'

export const metadata: Metadata = { title: 'Notifications — EduNation' }
    ...
    <div className="w-full min-w-0 space-y-4">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Emploi du temps, cours, bulletins et autres mises à jour récentes.
        </p>
      </div>
      <StudentNotificationsList notifications={notifications} />
    </div>
  )
}
